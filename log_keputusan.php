...
// Ambil data hanya yang status Disetujui
$sql = "SELECT * FROM rencana_pengadaan WHERE status = 'Disetujui' ORDER BY created_at DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Log Keputusan Pengadaan</title>
...
<body>
    <div class="sidebar text-white">
        ...
        <a href="log_keputusan.php" class="active"><i class="bi bi-building"></i> Log Keputusan</a>
        ...
        <div class="container-fluid">
            <div class="card shadow border-0">
                <div class="card-header bg-dark text-white">
                    <h4 class="mb-0"><i class="bi bi-check-circle"></i> Log Keputusan Pengadaan (Disetujui)</h4>
                </div>
                <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result->fetch_assoc()) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="feedback_pengadaan.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm">
                                                    <i class="bi bi-reply"></i> Feedback
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                    ...
                    <?php else : ?>
                        <div class="alert alert-warning">Belum ada data dengan status Disetujui.</div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
