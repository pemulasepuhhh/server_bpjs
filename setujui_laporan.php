...
$sql = "
    SELECT 
        ...
        p.cabang_id, -- Tambahkan cabang_id
        p.tanggal,
        c.nama_cabang,
        a.nama_aset,
        a.kode_aset,
...
// Masukkan ke tabel riwayat_laporan dengan cabang_id
$pelaporan_id = $data['pelaporan_id']; // pastikan ini diambil dari tabel pelaporan
...
$stmt_insert->bind_param(
    "iisssssss",
    $pelaporan_id,      // ✅ variabel, bukan array
    $data['cabang_id'],
    $data['tanggal'],
    $data['nama_cabang'],
    $data['nama_aset'],
...
header("Location: notifikasi.php?msg=laporan_disetujui");
exit;
